        ...
        <div ref={refModal} className="modal">
            <div className="modal-content rounded-0">
                <div className="rounded-0 d-block p-3 bg-warm">
                    <h3 className="text-center">{t('subscribe.title')}
                ...
                <form className='text-center' onSubmit={submit}>
                    <h1 className="fw-bold mb-1">{t('subscribe.email')}</h1>
                    <div>
                    ...
                    <div className="modal-body p-2">
                        <button type='submit' className="btn btn-outline-success rounded-0 w-100">{t('subscribe.confirm')}</button>
                    </div>
                </form>
            </div>
        </div>
