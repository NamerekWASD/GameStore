                ...
                <div className="container text-center text-md-start mt-5">
                    <div className="row mt-3">
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <button className="btn text-dark nav-link w-100 text-start" onClick={manager}>Менеджеру</button>
                            </p>
                        </div>
                        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                            ...
                            <p>
                                <a href="tel:+380639737449" className="text-dark"><FontAwesomeIcon icon={faPhone} /><span className="ms-1">+38(063)973-74-49</span></a>
                            </p>
                        </div>
                    </div>
                </div>
